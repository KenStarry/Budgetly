...
import 'package:budgetly/features/feature_accounts/domain/use_cases/delete_account.dart';
...
void invoke() {
  ...
  locator.registerLazySingleton<AccountsUseCases>(() => AccountsUseCases(
      addAccount: AddAccount(), deleteAccount: DeleteAccount()));
}
